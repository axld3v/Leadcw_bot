...
/**
 * This class represents the reopenForumTopic method in the Telegram Bot API.
 */
class ReopenForumTopic extends TelegramMethods
{
    public string $methodName = "ReopenForumTopic";
