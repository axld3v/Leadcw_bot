...
/**
 * This class represents the editChatInviteLink method in the Telegram Bot API.
 */
class EditChatInviteLink extends TelegramMethods
{
    public string $methodName = "EditChatInviteLink";
